        ...
        new TrajectoryConfig(AutoConstants.kMaxSpeedMetersPerSecond, 
            ...
            Trajectory exampleTrajectory = TrajectoryGenerator.generateTrajectory(
              ...
              List.of(
                ...
                new Pose2d(Units.inchesToMeters(6.5),Units.inchesToMeters(0), Rotation2d.fromDegrees(0)),
                new Pose2d(Units.inchesToMeters(15.5),Units.inchesToMeters(17.5), Rotation2d.fromDegrees(90)),
                new Pose2d(Units.inchesToMeters(10.0),Units.inchesToMeters(16.0), Rotation2d.fromDegrees(200)),
                new Pose2d(Units.inchesToMeters(0.0),Units.inchesToMeters(1.0), Rotation2d.fromDegrees(160)),
                new Pose2d(Units.inchesToMeters(-9.0),Units.inchesToMeters(13.5), Rotation2d.fromDegrees(90)),
                new Pose2d(Units.inchesToMeters(8.0),Units.inchesToMeters(22.5), Rotation2d.fromDegrees(-15)),
                new Pose2d(Units.inchesToMeters(14.5),Units.inchesToMeters(23.5), Rotation2d.fromDegrees(0))
              ),
              config);
